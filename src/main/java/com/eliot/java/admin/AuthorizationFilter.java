 ...
 * @author DRobin
 */
@WebFilter(filterName = "AuthorizationFilter", urlPatterns = {"/admin.xhtml", "/users.xhtml", "/devices.xhtml", "/associate.xhtml"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ERROR, DispatcherType.INCLUDE})
